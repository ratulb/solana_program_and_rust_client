...
- Decorate the implementation with the [entrypoint macro](https://github.com/solana-labs/solana/blob/f7d557d5ae5d2ebfb70c2eaefa7dd1e2068b748c/sdk/program/src/entrypoint.rs#L116). As we can see - net effect of invoking this macro is that our implemention function get embedded inside an external `c` function called `entrypoint`. 
- [Build the on-chain program](#build-the-on-chain-program)
